...
namespace plmOS.Logging
{
    public class EventLog : Log
    {
        ...
        private static System.Diagnostics.EventLogEntryType ConvertLevel(plmOS.Logging.Log.Levels Level)
        {
            switch (Level)
            {
                case plmOS.Logging.Log.Levels.FAT:
                case plmOS.Logging.Log.Levels.ERR:
                    return System.Diagnostics.EventLogEntryType.Error;
                case plmOS.Logging.Log.Levels.WAR:
